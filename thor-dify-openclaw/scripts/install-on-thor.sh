#!/usr/bin/env bash
# 在 Thor 上：提示如何匯入 Dify Chatflow 並掛 dispatcher。
set -euo pipefail
...
echo "  6. 把 k10/confirm.py 的 THOR 改成這台 LAN IP 後燒進 K10"
echo "  7. 試：python3 $ROOT/scripts/send_voice.py --source reachy '把桌上馬克杯送到客廳給 Hank'"
